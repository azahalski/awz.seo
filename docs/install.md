...
1) Передите на страницу решения в маркетплейс 1с-Битрикс [ссылка](https://marketplace.1c-bitrix.ru/solutions/awz.seo/)
...
1) Скачайте необходимую версию модуля с github, например, со страницы [releases](https://github.com/zahalski/awz.seo/releases)
2) Распакуйте архив
3) Загрузите модуль
   
**Если установка в UTF-8 версии**

Скопируйте папку с распакованного архива bitrix\modules\awz.seo в папку \bitrix\modules\ вашего сайта
...
- Переименовываем папку из .last_version в awz.seo
- Копируем нашу папку dist\awz.seo в папку \bitrix\modules\ вашего сайта
4) Проверяем или все верно
- Вместо awz.module на изображении Ваша папка будет с названием `awz.seo`
...
6) Выбираем модуль с кодом awz.seo и нажимаем установить
