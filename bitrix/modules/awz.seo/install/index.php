...
class awz_seo extends CModule
{
	var $MODULE_ID = "awz.seo";
	var $MODULE_VERSION;
    ...
    public function __construct()
	{
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_SEO_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_SEO_MODULE_DESCRIPTION");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("AWZ_SEO_MODULE_NAME"),
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) {
            $APPLICATION->IncludeAdminFile(
                Loc::getMessage('AWZ_SEO_INSTALL_TITLE'),
    ...
    {
        CopyDirFiles(
            $_SERVER['DOCUMENT_ROOT']."/bitrix/modules/".$this->MODULE_ID."/install/components/seo.config.permissions/",
            $_SERVER['DOCUMENT_ROOT']."/bitrix/components/awz/seo.config.permissions",
            true, true
        );
        return true;
    }
    ...
    {
        DeleteDirFilesEx("/bitrix/components/awz/seo.config.permissions");
        return true;
    }
